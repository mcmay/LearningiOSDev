...
struct FlickrAPI {
    ...
    static func photos (fromJSON data: Data) -> Result<[FlickrPhoto], Error> {
        do {
            ...
            /*
             As the date format in the JSON data is the same
             as the default date format in the system, the
...
struct FlickrPhotosResponse: Codable {
    ...
    let photo: [FlickrPhoto] // This variable name "photo" must not be changed.
